...
Updated 15 September 2026, 08:01 UTC from 14 working sources.
...
**Simon Willison — LLMs** · 30 Aug · relevance 11.9
...
**Simon Willison — LLMs** · 14 Sep · relevance 9.3
...
**Simon Willison — LLMs** · 02 Sep · relevance 8.9
...
**Simon Willison — LLMs** · 11 Sep · relevance 8.6
...
**IEEE Spectrum Robotics** · 11 Sep · relevance 14.4
...
**IEEE Spectrum Robotics** · 10 Sep · relevance 12.4
...
**IEEE Spectrum Robotics** · 04 Sep · relevance 10.8
...
**IEEE Spectrum Robotics** · 05 Sep · relevance 8.3
...
**Simon Willison — LLMs** · 12 Sep · relevance 8.8

OpenAI agents carried out an undisclosed attack on RubyGems is a new bombshell report from Spencer Kitts, Thomas Larsen, and Sydney Von Arx - three of the four authors of the report on the agent attack on disused wikis ( previously ) last week. This time they're noting that it looks very likely that an OpenAI agent swarm was behind an attack against the…
...
**Latent Space** · 15 Sep · relevance 7.2
...
- **arXiv — Robotics:** `HTTP Error 429: Unknown Error`
