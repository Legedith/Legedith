...
Updated 15 August 2026, 03:24 UTC from 17 working sources.
...
**arXiv — Robotics** · 13 Aug · relevance 12.4

Vision-Language Navigation (VLN) for humanoid robots poses challenges existing benchmarks fail to address: bipedal locomotion imposes physical constraints absent from wheeled agents, humanoid morphologies vary across platforms, and egocentric observations are distorted by locomotion-induced camera dynamics. We present HumanoidVLN, a physics-grounded…

### [Video Friday: Lift Happens](https://spectrum.ieee.org/video-friday-darpa-heavy-lift-challenge)

**IEEE Spectrum Robotics** · 14 Aug · relevance 11.8
...
**IEEE Spectrum Robotics** · 17 Jul · relevance 11.3
...
**IEEE Spectrum Robotics** · 03 Aug · relevance 10.8
...
**arXiv — AI, language and HCI** · 13 Aug · relevance 14.0

Scientific discovery increasingly requires AI systems that can reason over scientific evidence of heterogeneous modalities, interact with scientific tools and environments, and sustain progress across long task horizons. We present Intern-S2-Preview, a series of scientific agentic foundation models designed to support multimodal scientific understanding,…

### [RGB-D Video Generation for Improving Human-to-Robot Object Handover Prediction](https://arxiv.org/abs/2608.13028v1)

**arXiv — Robotics** · 13 Aug · relevance 13.1

Human-to-robot (H2R) object handover is a fundamental capability for human-robot collaboration, yet progress is hindered by the scarcity of large-scale, human-centric datasets and the significant sim-to-real gap. To address these challenges, we introduce Hand2Bot, an RGB-D video dataset that provides rich contextual information such as body posture and…

### [G0.5: One Autoregressive Stream for Robot Reasoning and Action](https://arxiv.org/abs/2608.11739v1)

**arXiv — Robotics** · 12 Aug · relevance 12.5
...
**arXiv — AI, language and HCI** · 13 Aug · relevance 12.3
...
**arXiv — AI, language and HCI** · 13 Aug · relevance 11.9

On-policy distillation (OPD) supervises a student language model on trajectories sampled from its current policy, but assigns equal credit to response tokens with unequal supervision value. Selective OPD addresses this limitation by allocating supervision non-uniformly across response tokens according to their estimated training value. Most existing…

## Evaluation

### [Vero: Can AI Agents Build Formally Verified Software Repositories?](https://arxiv.org/abs/2608.13522v1)

**arXiv — AI, language and HCI** · 13 Aug · relevance 16.0

AI agents are increasingly used for programming, but do not provide any guarantee on the correctness of generated code. Verified code generation, in which an agent produces both an implementation and a machine-checked proof of its specification, offers a stronger path toward trustworthy AI-generated software. Existing benchmarks in this direction either…
...
**arXiv — AI, language and HCI** · 13 Aug · relevance 13.2
...
**Simon Willison — LLMs** · 08 Aug · relevance 12.4
...
**Simon Willison — LLMs** · 11 Aug · relevance 11.9
...
**Simon Willison — LLMs** · 05 Aug · relevance 11.7

Incident Report: unsanctioned agent behaviour during cyber testing It happened again . This time it was the UK government's AI Security Institute who accidentally attacked other companies while running an evaluation with models with the safety filters turned off. From their technical paper (PDF): During a cyber evaluation, from 25 to 28 July 2026, AI…
...
**Simon Willison — LLMs** · 31 Jul · relevance 10.5
...
**arXiv — AI, language and HCI** · 13 Aug · relevance 13.0

Large language model based multi-agent systems usually communicate in text, i.e., using discrete tokens. However, text introduces a discrete bottleneck. Converting the sender's continuous hidden states into discrete tokens discards information that token identities alone cannot capture. Recent work proposes latent communication as an alternative, where…

### [Introducing Muse Glimmer](https://simonwillison.net/2026/Aug/10/introducing-muse-glimmer)

**Simon Willison — LLMs** · 10 Aug · relevance 12.5
